                    ...
                    Row(
                      children: [
                        ...
                        Container(
                          ...
                          child: Center(
                            child: Text(MyStrings.past,style: TextStyle(color: Colors.white,fontSize: 25),),
                          ),
                        ),
                      ],
                    ),
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text('+4 Karma',style: TextStyle(color: Color(0xff16F60E),fontSize: MediaQuery.of(context).size.width*.05 ),),
                        Spacer(),
                        Image.asset(MyImages.dropDownIcon,height: MediaQuery.of(context).size.height*.03,)
                      ],
                    ),
                  ),
                ],
